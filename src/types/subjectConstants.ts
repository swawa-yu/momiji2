// Generated from validated syllabus data, data/subjectConstants.json, and Harvester-derived data/department_constants.json
// Do not edit this file directly.

export const campuses = ['東広島', '霞', '東千田', '双方向'] as const;
...
export const kaikouBukyokuDaigakuins = [
  ...
  '先進理工系科学研究科博士課程後期先進理工系科学専攻理工学融合プログラム',
...
export const rishuNenjiNumbers = [1, 2, 3, 4, 5, 6] as const;
